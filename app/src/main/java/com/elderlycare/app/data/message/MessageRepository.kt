...
class MessageRepository(
    ...
    fun observeUnreadBindingCount(): Flow<Int> = dao.observeUnreadBindingCount()

    /** 进入授权管理页批量标记绑定申请消息已读（红角标随之消失） */
    suspend fun markBindingMessagesRead() = dao.markBindingMessagesRead()
